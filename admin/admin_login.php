        ...
        if ($response_data["status"] === "success") {
            ...
            if ($res->num_rows > 0) {
                ...
                if ($org_result->num_rows > 0) {
                    ...
                    $confirmation_message = 'Welcome back, Admin! Ready to manage your organization?';
                    $redirect_url = 'admin_dashboard.php';
                } else {
                    $show_confirmation = true;
                    $confirmation_message = 'Welcome! Please set up your organization to get started.';
                    $redirect_url = 'register_organization.php';
                }
            } else {
                $login_error = 'Session error. Please try logging in again.';
            }
        } else {
...
<head>
    ...
    <title>Admin Login — VolunteerHub</title>
    ...
    <style>
      ...
      .footer-link a { font-size: .88rem; color: var(--green-mid); font-weight: 500; text-decoration: none; }
...
<?php if ($show_confirmation): ?>
  ...
  <div class="login-modal">
    <div class="login-modal-content">
      ...
      <p><?= htmlspecialchars($confirmation_message, ENT_QUOTES) ?></p>
  ...
  <div class="container">
    ...
    <form method="POST" id="loginForm" novalidate>
      ...
      <div class="forgot-link">
        <a href="/VolunteerHub/forgot_password.php?role=Admin">Forgot password?</a>
      </div>

      <input type="hidden" name="role" value="Admin">

      <button type="submit" class="btn-login" id="submitBtn" onclick="this.classList.add('loading')">
        Login as Admin
      </button>
    </form>
